<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Scada.Master" AutoEventWireup="true" CodeBehind="HongXuat6.aspx.cs" Inherits="Web_XANGDAU.WebForms.HongXuat6" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <asp:Timer ID="Timer_Hong6" Interval="1000" runat="server" OnTick="Timer_Hong6_Tick"></asp:Timer>
            <div class="tank_title">
                        <i class="bi bi-droplet-half" style="background:brown;"></i>
                        <span class="title_Tank">Họng 6 - RON95 Tank 2</span>
                    </div>
                    <div class="tank">
