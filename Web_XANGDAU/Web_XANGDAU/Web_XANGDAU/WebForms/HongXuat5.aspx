<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Scada.Master" AutoEventWireup="true" CodeBehind="HongXuat5.aspx.cs" Inherits="Web_XANGDAU.WebForms.HongXuat5" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <asp:Timer ID="Timer_Hong5" Interval="1000" runat="server" OnTick="Timer_Hong5_Tick"></asp:Timer>
            <div class="tank_title">
                        <i class="bi bi-droplet-half" style="background:brown;"></i>
                        <span class="title_Tank">Họng 5 - RON95 Tank 1</span>
                    </div>
                    <div class="tank">
