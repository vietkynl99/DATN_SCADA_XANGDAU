<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Scada.Master" AutoEventWireup="true" CodeBehind="HongXuat2.aspx.cs" Inherits="Web_XANGDAU.WebForms.HongXuat2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <asp:Timer ID="Timer_Hong2" runat="server" Interval="1000" OnTick="Timer_Hong2_Tick"></asp:Timer>
            <div class="tank_title">
                <i class="bi bi-droplet-half" style="background: #7380ec;"></i>
                <span class="title_Tank">Họng 2 - Diezel Tank 2</span>
            </div>
            <div class="tank">     
                ...
                <div class="symbol">
                 ...
                 <div class="box output">
                     ...
                     <asp:TextBox ID="txt_Muc" type="text" class="form-control-sm textbox Muc" runat="server" ReadOnly="True" ToolTip="Mức dầu"></asp:TextBox>
                     <asp:TextBox ID="txt_NhietDo" type="text" class="form-control-sm textbox NhietDo" runat="server" ReadOnly="True" ToolTip="Nhiệt độ bể dầu"></asp:TextBox>
                 </div>
